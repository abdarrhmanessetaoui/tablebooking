...
import { DARK, GOLD, GOLD_DARK, BORDER } from '../../../styles/reservations/tokens.js'
...
export default function ReservationsTable({
  ...
  const allSelected =
    ...
    reservations.every(r => selectedIds.includes(r.id))
  ...
  const pageAllSel =
    pageItems.length > 0 &&
    pageItems.every(r => selectedIds.includes(r.id))

  const pageSomeSel =
    pageItems.some(r => selectedIds.includes(r.id)) && !pageAllSel
      ...
      >
        ...
        <div className="res-table-wrap">
          <DesktopTable
            ...
            toggleOne={toggleOne}
            pageAllSel={pageAllSel}
            pageSomeSel={pageSomeSel}
