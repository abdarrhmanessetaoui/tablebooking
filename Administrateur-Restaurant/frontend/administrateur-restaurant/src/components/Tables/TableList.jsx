...
export default function TableList({ tables, editingTbl, onEdit, onDelete, onToggle, selectedTables, setSelectedTables }) {
  ...
  return (
    <>
      ...
      {/* Stats bar */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, max-content)', width: '100%', marginBottom: 12 }}>
        {[
          { label: 'Total',    val: String(tables.length) },
          { label: 'Actives',  val: String(activeCnt) },
