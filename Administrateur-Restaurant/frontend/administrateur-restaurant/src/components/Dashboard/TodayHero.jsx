  ...
  return (
    <div style={{ position: 'relative', width: size, height: size, flexShrink: 0 }}>
      ...
      <div style={{
        ...
        <span style={{ fontSize: 19, fontWeight: 900, color: B.ink, lineHeight: 1 }}>{animRate}%</span>
      ...
      <div style={{ padding: '26px 30px 24px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 38, flexWrap: 'wrap' }}>
          <div style={{ flex: '0 0 auto' }}>
            ...
            <p style={{ margin: '13px 0 0', fontSize: 15, fontWeight: 700, color: B.inkSub }}>réservations ce soir</p>
